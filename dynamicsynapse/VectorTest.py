...
#    scale = 1
    ...
    WeightersCentre = np.ones(NumberOfSynapses) * 0.3+ 0.05 * (np.random.rand(NumberOfSynapses[0], NumberOfSynapses[1])-0.5)   # np.ones(NumberOfSynapses)/2+[0.2, 0.1,0.0, 0.2, 0]  #[0.2, 0.1, 0]
